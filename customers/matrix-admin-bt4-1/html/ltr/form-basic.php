...
<head>
    ...
    <title>KB-Admin Dashboard</title>
                ...
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="index2.php">
                        ...
                        <span class="logo-text">
                             <!-- dark Logo text -->
                             <!-- <img src="dash/assets/images/logo-text.png" alt="homepage" class="light-logo" /> -->
                ...
                <!-- Sidebar navigation-->
                 <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="p-t-30">
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="index1.php" aria-expanded="false"><i class="mdi mdi-view-dashboard"></i><span class="hide-menu">Dashboard</span></a></li>
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="admins.php" aria-expanded="false"><i class="mdi mdi-border-inside"></i><span class="hide-menu">Admin List</span></a></li> -->
                        <li class="sidebar-item"><a  class="sidebar-link waves-effect waves-dark sidebar-link" href="form-basic.php" aria-expanded="false"><i class="mdi mdi-note-outline"></i><span class="hide-menu"> Edit Account Details </span></a></li>
                        <!-- <li class="sidebar-item"><a class="sidebar-link waves-effect waves-dark sidebar-link" aria-expanded="false" href="registration2.php" class="sidebar-link"><i class="mdi mdi-account-key"></i><span class="hide-menu"> Register New Admin</span></a></li> -->
                    </ul>
                </nav>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <form class="form-horizontal" action="update_pdetails.php" method="post">
                                <div class="card-body">
