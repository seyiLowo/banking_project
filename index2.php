...
<head>
    ...
    <title>KB-Staff Dashboard</title>
            ...
            <div class="container-fluid">
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="bg-dark p-10 text-white text-center">
                                                   ...
                                                   <h5 class="m-b-0 m-t-5">109</h5>
                                                   <small class="font-light">Total Clients</small>
                                                </div>
                                            </div>
                                             <div class="col-6">
                                                <div class="bg-dark p-10 text-white text-center">
                                                   <i class="fa fa-plus m-b-5 font-16"></i>
                                                   <h5 class="m-b-0 m-t-5">6</h5>
                                                   <small class="font-light">New Clients For The Month</small>
                                                </div>
                                            </div>
                                            <div class="col-6 m-t-15">
                                                <div class="bg-dark p-10 text-white text-center">
                                                   <i class="fa fa-cart-plus m-b-5 font-16"></i>
                                                   <h5 class="m-b-0 m-t-5">$100,000</h5>
                                                   <small class="font-light">Deposit Target For The Month</small>
                                                </div>
                                            </div>
                                             <div class="col-6 m-t-15">
                                                <div class="bg-dark p-10 text-white text-center">
                                                   <i class="fa fa-tag m-b-5 font-16"></i>
                                                   <h5 class="m-b-0 m-t-5">$4,000</h5>
                                                   <small class="font-light">Total Deposits For The Month</small>
                                                </div>
                                            </div>
                                            <div class="col-6 m-t-15">
                                                <div class="bg-dark p-10 text-white text-center">
                                                   <i class="fa fa-table m-b-5 font-16"></i>
                                                   <h5 class="m-b-0 m-t-5">$500</h5>
                                                   <small class="font-light">Total Withdrawal For The Month</small>
                                                </div>
                                            </div>
                                            <div class="col-6 m-t-15">
                                                <div class="bg-dark p-10 text-white text-center">
                                                   ...
                                                   <small class="font-light">Monthly New Client Target</small>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                            ...
                            <div class="card-body">
                                ...
                                <div class="m-t-20">
                                    <div class="d-flex no-block align-items-center">
                                        <span>Monthly Client Target 60%</span>
                                        <div class="ml-auto">
                                            <span>6</span>
                                        </div>
                                    </div>
                                ...
                                <div>
                                    <div class="d-flex no-block align-items-center m-t-25">
                                        <span>Monthly Deposit Target 20%</span>
                                        <div class="ml-auto">
                                            <span>$4,000</span>
                                        </div>
                                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title m-b-0">Staff News Updates</h4>
                            </div>
                            <ul class="list-style-none">
                                ...
                                <li class="d-flex no-block card-body border-top">
                                    ...
                                    <div>
                                        <a href="#" class="m-b-0 font-medium p-0">Congratulation, Happy Birthday</a>
                                ...
                                <li class="d-flex no-block card-body border-top">
                                    ...
                                    <div>
                                        <a href="#" class="m-b-0 font-medium p-0">Build a Responsive Admin theme</a>
                                ...
                                <li class="d-flex no-block card-body border-top">
                                    ...
                                    <div>
                                        <a href="#" class="m-b-0 font-medium p-0">Envato approved Admin template</a>
